...
single & is for logical anding(completely outside of window)
{
done=1;
}
else
{
if(outcode1==0)//p1 //if one endpoint is completely inside the
window
...
int main(int argc,char **argv)
{
 ...
 glutCreateWindow("OpenGL - Cohen Sutherland Line Clipping Algo - SIA03");
 initialize();
