...
:
 ...
 bresenhams_circle(xc,yc,r);
 bresenhams_circle(xc+
2*r,yc,r);
 bresenhams_circle(xc,yc+
2*r,r);
 bresenhams_circle(xc2*r,yc,r);
 bresenhams_circle(xc,yc2*r,r);
 break
;
 case 'q'
:
...
int main(int argc,char **argv)
{
 ...
 glutCreateWindow("OpenGL - Bresenham's Circle Drawing Algo");
 initialize();
